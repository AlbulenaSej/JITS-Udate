...
function checkUserid(textInput){
	var myMsg = "";
	if (textInput == ""){
		myMsg = "Die Useridentifikation darf nicht leer sein";
	}else if(textInput.length < 6){
		myMsg = "Die Useridentifikation muss mindestens 6 Zeichen lang sein";
...
//	alert(myImg1.src);
	...
	var newFile = "";
	var newClass = "";
	if (myFile == "JITSLOGO.jpg"){
		newFile = "JITSLOGO.jpg";
		newClass = "JITS";
	}else{
		newFile = "JITSLOGO.jpg";
		newClass = "jits1";
